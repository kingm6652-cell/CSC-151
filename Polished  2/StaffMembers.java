...
public class StaffMembers {
        ...
        try (java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.FileReader(filename))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length == 2) {
                    ...
                    staffList.add(new StaffMember(name, title));
                }
            }
            mainStaff = staffList.toArray(new StaffMember[0]);
    ...
    public static void main(String[] args) {
        ...
        if (!csvFile.exists()) {
            ...
            mainStaff = defaultStaff;
            writeMainStaffToCSV(csvFileName);
        }
        readMainStaffFromCSV(csvFileName);
